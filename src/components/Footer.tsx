...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0d1234] text-white pt-20 pb-10 px-6 md:px-10 lg:px-12 2xl:px-16 border-t border-white/10">
      <div className="max-w-7xl 2xl:max-w-[1400px] 3xl:max-w-[1600px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 2xl:gap-16 mb-20">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://github.com/Renevise" target="_blank" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/case-studies" className="text-white/60 hover:text-white transition-colors text-sm">Case Studies</Link></li>
              <li><Link href="/about" className="text-white/60 hover:text-white transition-colors text-sm">Mission</Link></li>
