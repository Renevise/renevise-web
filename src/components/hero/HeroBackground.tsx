...
/**
 * Deep navy atmospheric background: gradient base, dot grid,
 * radial accent glows (toned down), and slow drifting particles.
 * Pointer-events disabled so it never intercepts drag/clicks.
 */
