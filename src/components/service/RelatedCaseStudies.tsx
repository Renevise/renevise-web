      ...
      <div className="max-w-7xl 2xl:max-w-[1400px] mx-auto px-6 py-20 md:py-28">
        <FadeIn>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12 md:mb-14">
            ...
            <Link
              href="/case-studies"
              className="group inline-flex items-center gap-2 text-sm font-bold text-accent self-start md:self-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60 rounded-md"
            >
              View all case studies
              <ArrowRight className="w-4 h-4 transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-x-1" />
            </Link>
          </div>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-stretch">
          {studies.map((study, i) => (
            <FadeIn key={study._id} delay={i * 0.08} className="h-full">
              <Link
              ...
              >
                ...
                {study.image && (
                  <div className="relative aspect-[16/10] overflow-hidden">
                    ...
                    <div
                      aria-hidden
                      className="pointer-events-none absolute inset-0 bg-gradient-to-t from-primary/45 via-transparent to-transparent transition-opacity duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:from-primary/55"
                    />

                    {/* Service badge */}
                    <span className="absolute top-4 left-4 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/95 backdrop-blur-sm text-[10px] font-bold uppercase tracking-[0.14em] text-primary shadow-sm transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:-translate-y-0.5">
                ...
                <div className="flex flex-1 flex-col p-6 md:p-7">
                  ...
                  {study.result && (
                    <div className="inline-flex w-fit items-center gap-2 bg-accent/10 text-accent rounded-theme px-3 py-2 mb-5">
